 ...
 *	@kind : controller
 *	@description : 矩形组件通用controller
 */

var module = angular.module("componentsController.dyPanel", []);

module.controller('dyPanel', ['$scope', '$unique_id', '$compile', '$element', '$document', '$datasource_factory', '$console', '$timeout', '$componentProperty', '$rootScope',
  ...
  function($scope, $unique_id, $compile, $element, $document, $datasource_factory, $console, $timeout, $componentProperty, $rootScope) {
    ...
    $scope.directiveStr = "<div prop-panel></div>";
...
module.controller('propPanel', ['$scope', '$componentProperty', '$_imagesUpload', '$_deleteImage', function($scope, $componentProperty, $_imagesUpload, $_deleteImage) {
